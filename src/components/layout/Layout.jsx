...
export default function Layout() {
    return(
        ...
        xl:flex-row">
            ...
            <main className="main-container h-[45%] w-full flex flex-col order-3
            lg:h-full lg:w-5/9 lg:order-2
            xl:h-full xl:w-5/9 xl:order-2 ">
                <Primary.Default />
            </main>
            <section className="side-container h-[40%] w-full top-2/3 border-t-[2px] border-light-tertiary order-2
